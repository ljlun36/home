...
-\[15] Selberg, Ihara and Berkovich 🔗 [[arXiv]](https://arxiv.org/abs/2412.20754), with Carlos Matheus, Wenyu Pan, Zhongkai Tao, arXiv:2412.20754



-\[14] On the Dimension of Limit Sets on RP^2 via Stationary Measures II: variational principles and applications 🔗 [[arXiv]](https://arxiv.org/abs/2311.10262) , with Yuxiang Jiao, Wenyu Pan, Disheng Xu, accepted by IMRN
...
-\[11] Stationary measures for SL2(ℝ)-actions on homogeneous bundles over flag varieties 🔗 [[arXiv]](https://arxiv.org/abs/2211.06911), with Alex Gorodnik, Cagri Sert, accepted by Crelle's Journal 
...
[Lecture notes](./assets/lec-coding.pdf) for a working seminar in SLmath 2026, explaining the construction of coding.



-\[8] Appendix of: The space of homogeneous probability measures on Γ∖X  is compact 🔗 [[arXiv]](https://arxiv.org/abs/1910.04568), by Christopher Daw, Alexander Gorodnik, Emmanuel Ullmo, Math. Ann. 386, 987–1016 (2023).



-\[7] Fourier transform of self-affine measures, with Tuomas Sahlsten 🔗 [[arXiv]](https://arxiv.org/abs/1903.09601), Advances in Mathematics 374 (2020).
...
-\[5] Kleinian Schottky groups, Patterson-Sullivan measures, and Fourier decay, with an appendix on stationarity of Patterson-Sullivan measures 🔗 [[arXiv]](https://arxiv.org/abs/1902.01103), with Frédéric Naud and Wenyu Pan, Duke Math. J. 170, issue 4, (2021) pp. 775 - 825.
...
-\[3] Discretized Sum-product and Fourier decay in Rn 🔗 [[arXiv]](https://arxiv.org/abs/1811.06852),  Journal d'Analyse Mathématique, 143,  (2021) pp. 763–800.



-\[2] Finiteness of Small Eigenvalues of Geometrically Finite Rank one Locally Symmetric Manifolds 🔗 [[arXiv]](https://arxiv.org/abs/1811.06357),  Mathematical Research Letters, 27, number 2 (2020) pp. 465 – 500.



-\[1] Decrease of Fourier Coefficients of Stationary Measures 🔗 [[arXiv]](https://arxiv.org/abs/1706.07184 ), Mathematische Annalen, 372, (2018) pp. 1189–1238. 
